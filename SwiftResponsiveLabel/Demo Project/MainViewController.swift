...
class MainViewController: UIViewController {
	...
	@IBAction func enableHashTagButton(_ sender:UIButton) {
		...
		if sender.isSelected {
            ...
            let patternAttributes: [NSAttributedStringKey: AnyObject] = [RLHighlightedAttributesDictionary : highlightedAttributes as AnyObject, NSAttributedStringKey.foregroundColor: UIColor.cyan, RLTapResponderAttributeName:hashTagTapAction]
	...
	@IBAction func enableUserhandleButton(_ sender:UIButton) {
		...
		if sender.isSelected {
            ...
            self.customLabel.enableUserHandleDetection(attributes: [NSAttributedStringKey.foregroundColor:UIColor.gray,
	...
	@IBAction func enableURLButton(_ sender:UIButton) {
		...
		if sender.isSelected {
            ...
            self.customLabel.enableURLDetection(attributes: [NSAttributedStringKey.foregroundColor:UIColor.blue, RLTapResponderAttributeName:URLTapAction])
		} else {
	...
	@IBAction func handleSegmentChange(_ sender:UISegmentedControl) {
		...
		case 0:
            ...
            let dict = [RLHighlightedBackgroundColorAttributeName:UIColor.black,
			            RLHighlightedForegroundColorAttributeName:UIColor.green,RLTapResponderAttributeName:action] as [NSAttributedStringKey : Any]
