...
open class SwiftResponsiveLabel: UILabel {
	...
	*/
	...
	fileprivate var attributesFromProperties: [NSAttributedStringKey: AnyObject] {
		let shadow = NSShadow()
	...
	*/
	open func enableURLDetection(attributes:[NSAttributedStringKey: AnyObject]) {
		do {
	...
	- parameters:
		- attributes: [String:AnyObject]
	*/
	open func enableUserHandleDetection(attributes: [NSAttributedStringKey: AnyObject]) {
	...
	- parameters:
		- attributes: [String:AnyObject]
	*/
	open func enableHashTagDetection(attributes: [NSAttributedStringKey: AnyObject]) {
	...
	- parameters:
		...
		- attributes: [String:AnyObject]
	*/
	open func enableStringDetection(_ string: String, attributes: [NSAttributedStringKey: AnyObject]) {
	...
	- parameters:
		...
		- attributes: [String:AnyObject]
	*/
	open func enableDetectionForStrings(_ stringsArray: [String], attributes:[NSAttributedStringKey: AnyObject]) {
	...
	*/
	...
	fileprivate func highlightPattern(_ pattern: String, attributes:[NSAttributedStringKey:AnyObject]) {
